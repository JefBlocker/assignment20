...
},{"./contact":3,"backbone":12}],5:[function(require,module,exports){
'use strict';
...
},{"./contact":3,"./contacts":4}],6:[function(require,module,exports){
'use strict';
...
exports['default'] = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.$el.on('click', '.create-contact', function (event) {
      console.log('Redirect to AddContact');
      var $li = (0, _jquery2['default'])(event.currentTarget);
      _this.navigate('addContact', { trigger: true });
    });

    this.$el.on('click', '.add-new-contact', function (event) {
      ...
      var model = new _resources.Contact({
        Name: name,
        Email: email,
        Phone: phone,
        Location: location
      ...
      model.save().then(function () {
        _this.navigate('contacts', { trigger: true });
      });
    });
  },
  ...
  showContact: function showContact(id) {
    ...
    if (contact) {
      this.$el.html((0, _views.Contact)(contact.toJSON()));
    } else {
      this.showSpinner();
      contact = this.collection.add({ objectId: id });
      contact.fetch().then(function () {
        _this3.$el.html((0, _views.Contact)(contact.toJSON()));
      });
    }
  },
  ...
  newContact: function newContact() {
    this.showSpinner();
    this.$el.html((0, _views.AddContact)());
  }

});
module.exports = exports['default'];

},{"./resources":5,"./views":10,"backbone":12,"jquery":13}],7:[function(require,module,exports){
"use strict";
...
exports.Contact = _contact2['default'];
exports.Contacts = _contacts2['default'];
exports.AddContact = _addContact2['default'];
exports.Spinner = _spinner2['default'];

},{"./addContact":7,"./contact":8,"./contacts":9,"./spinner":11}],11:[function(require,module,exports){
"use strict";
